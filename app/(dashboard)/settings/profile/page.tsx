...
export default function ProfileSettingsPage() {
  ...
  const cities = form.state ? STATES[form.state as keyof typeof STATES] : [];
  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      <div className="bg-white border rounded-xl p-6 space-y-6">
        ...
        <Textarea label="Address" value={form.address} onChange={(v) => handleChange("address", v)} />
...
function Input({ label, value, onChange, disabled = false, maxLength }: any) {
  return (
    <div>
